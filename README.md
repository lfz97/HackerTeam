...
├── HackerTeam.log
├── ReconSkills/pentest-tools/SKILL.md
├── VulnAnalyzeSkills/pentest-tools/SKILL.md
├── ExploitSkills/pentest-tools/SKILL.md
└── PostExploitSkills/pentest-tools/SKILL.md
```
...
每个 Agent 拥有独立的 Skill 目录，通过 **`SKILL.md`** 文件以知识注入方式告知 Agent 如何使用外部安全工具（nmap / nuclei / sqlmap / dirsearch / fscan 等）：
